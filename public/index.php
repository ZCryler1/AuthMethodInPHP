...
<body>
    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <p class="signup-link">Não tem uma conta ainda? <a href="register.php">Crie!</a></p>
            <form action="login.php" method="POST">
                <div class="input-group">
                    <i class="fa fa-envelope"></i><input type="email" id="email" name="email" placeholder="Endereço de email" required>
                </div>
                <div class="input-group">
